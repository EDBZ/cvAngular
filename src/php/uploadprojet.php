...
// Constantes=========================================================
define('TARGET', '../upload/projets/');    // Repertoire cible
          ...
          // On verifie les dimensions et taille de l'image
          {
            ...
            if(($infosImg[0] <= WIDTH_MAX) && ($infosImg[1] <= HEIGHT_MAX) && ($poid <= MAX_SIZE))
            {
                ...
                && UPLOAD_ERR_OK === $file_error)
              {
                ...
                $resize = imagecreatetruecolor(1024, (1024*$hauteur_destination)/$largeur_destination);
                ...
                {
// ================================================================================
$req = $bdd->prepare('INSERT INTO projetweb (preview,titre,link,description,date_ajout)   VALUES(?,?,?,?,NOW())');
$req->execute(array(
  TARGET.$file_name,
  $_POST['titre'],
  $_POST['url'],
